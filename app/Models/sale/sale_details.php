...
class sale_details extends Model
{
    ...
    public function product_packagings(): hasMany
    {
    ...
    {
        return $this->HasMany(SaleReturnDetails::class, 'sale_detail_id', 'id');
    }
    ...
    {
        return $this->hasMany(EcommerceOrder::class, 'sale_id', 'sales_id');
    }
}
