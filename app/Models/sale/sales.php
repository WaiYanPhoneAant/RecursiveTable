...
class sales extends Model
{
   ...
   public function sold_by(): HasOne
    ...
    {
        return $this->belongsTo(EcommerceOrder::class, 'id', 'sale_id');
    }
    public function pos()
    {
        return $this->hasOne(posRegisters::class, 'id', 'channel_id');
    }

    public function ecommerceOrders()
    {
        return $this->hasMany(EcommerceOrder::class, 'sale_id');
    }
